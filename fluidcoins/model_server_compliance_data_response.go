...
type ServerComplianceDataResponse struct {
	Industries []MerchantIndustry `json:"industries,omitempty"`
	// Generic message that tells you the status of the operation
	Message string `json:"message,omitempty"`
	Status bool `json:"status,omitempty"`
	Uploader *ServerComplianceDataResponseUploader `json:"uploader,omitempty"`
}
